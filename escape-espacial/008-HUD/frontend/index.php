...
<body>
    ...
    <a-scene>
        <!-- Cámara del jugador con arma visible -->
        <a-entity camera wasd-controls look-controls position="0 1.6 0">
            ...
            <a-entity id="arma" position="0 -0.5 -0.8" rotation="0 0 0">
                <a-box width="0.2" height="0.2" depth="0.5" color="#333"></a-box>
            </a-entity>
        </a-entity>
    ...
    <script>
        ...
        let municionValor = document.getElementById("municionValor");
        let gameOver = false;
