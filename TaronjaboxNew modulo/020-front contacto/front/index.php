...
<body>
    ...
    <main>
        ...
        <section id="sobre-nosotros">
            ...
            <a href="./modulos/sobre_nosotros/sobre_nosotros.php">Leer más</a>
        </section>
        <section id="contacto">
            <h2>Contacto</h2>
            <p>¿Tienes alguna pregunta o consulta? Escríbenos.</p>
            <a href="modulos/contacto/contacto.php">Ir a Contacto</a>
        </section>
    </main>
</body>
</html>
