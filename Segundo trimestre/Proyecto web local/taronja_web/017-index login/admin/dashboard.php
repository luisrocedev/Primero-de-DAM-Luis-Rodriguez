...
<link rel="stylesheet" href="css/dashboard.css"> <!-- Asegúrate de que la ruta sea correcta -->
<link rel="stylesheet" href="css/header.css"> <!-- Incluir el estilo del encabezado -->
...
<header>
    <nav>
        <ul>
            ...
            <li><a href="blog/index.php">Blog</a></li> <!-- Enlace a la página del blog -->
            <li><a href="nuestro_equipo/index.php">Nuestro equipo</a></li> <!-- Enlace a la página de nuestro equipo -->
            <li><a href="quienes_somos/index.php">Quienes somos</a></li> <!-- Enlace a la página "quienes somos" -->
            <li><a href="fisioterapia/index.php">Fisioterapia</a></li> <!-- Enlace a la página de fisioterapia -->
            <li><a href="precios/index.php">Precios</a></li> <!-- Enlace a la página de precios -->
            <li><a href="contacto/index.php">Contacto</a></li> <!-- Enlace a la página de contacto -->
