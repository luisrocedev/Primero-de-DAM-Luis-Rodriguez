...
while True:
  ...
  if opcion == "1":
    ...
    Titulo = input("Introduce el Titulo del dato a actualizar:")
    Subtitulo = input("Introduce el Subtitulo del dato a actualizar:")
    Texto = input("Introduce el Texto del dato a actualizar:")
    peticion = f"""
    UPDATE datos
    SET 
        Titulo = '{Titulo}',
