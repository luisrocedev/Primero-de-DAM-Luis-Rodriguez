...
# Los métodos operan sobre los atributos del objeto y permiten interactuar con ellos o modificarlos.
...
class Smartphone:
    ...
    # Método para cargarbateria CON UN PARAMETRO
...
# Llamar a métodos pasando parámetros
mi_iphone.calculo(500)
mi_iphone.cargabateria()



# PARAMRTROS PREDETERMINADOS

class movil:
    def smartphone(self, nombre="iPhone"):
        print(f"Tengo el {nombre}")

# Crear una instancia de la clase Saludo
mi_movil = movil()

# Llamar al método con y sin parámetro
mi_movil.smartphone("iPhone16pro")  # Tengo el iPhone16pro
mi_movil.smartphone()          # Tengo el iphone
