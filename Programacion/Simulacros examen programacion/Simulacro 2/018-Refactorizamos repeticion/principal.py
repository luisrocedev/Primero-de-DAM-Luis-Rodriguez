...
while True:
    ...
    if opcion == "1":
         ...
         Titulo = input("Introduce el Titulo del capítulo a actualizar (en blanco para no modificar):")
         Subtitulo = input("Introduce el Subtitulotitulo del Subtitulo a actualizar (en blanco para no modificar):")
         Imagen = input("Introduce el Imagen del capítulo a actualizar (en blanco para no modificar)")
         Video = input("Introduce el Video del capítulo a actualizar (en blanco para no modificar):")
         Texto = input("Introduce el Texto del capítulo a actualizar (en blanco para no modificar):")
