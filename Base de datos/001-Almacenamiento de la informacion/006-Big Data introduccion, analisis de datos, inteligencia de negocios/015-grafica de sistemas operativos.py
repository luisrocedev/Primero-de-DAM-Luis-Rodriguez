import sqlite3
import matplotlib.pyplot as plt #importamos libreria para crear graficas
...
datos.append(filas[0][0])
 #############  Imprimir los resultados obtenidos en la lista de datos  con grafica#############
print(datos)
plt.xlabel('SSOO')
plt.ylabel('Cantidad')
plt.title('Cantidad de visualizaciones de diferentes SSOO')
plt.bar(etiquetas, datos)
plt.savefig('sografica.png')
plt.close()
