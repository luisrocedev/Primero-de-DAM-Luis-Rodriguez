...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 26-10-2024 a las 18:32:14
...
('root', '[{\"db\":\"blog\",\"table\":\"usuarios\"},{\"db\":\"crossfit\",\"table\":\"entrenadores\"},{\"db\":\"crossfit\",\"table\":\"membresias\"},{\"db\":\"crossfit\",\"table\":\"asistencias\"},{\"db\":\"crossfit\",\"table\":\"clases\"},{\"db\":\"crossfit\",\"table\":\"clientes\"},{\"db\":\"crossfit\",\"table\":\"tabla membres\\u00edas\"},{\"db\":\"crossfit\",\"table\":\"tabla entrenadores\"},{\"db\":\"crossfit\",\"table\":\"tabla clientes\"},{\"db\":\"crossfit\",\"table\":\"tabla clases\"}]');
...
('crossfit', 'asistencias', 3, 931, 493),
('crossfit', 'clases', 3, 239, 478),
('crossfit', 'clientes', 3, 949, 133),
('crossfit', 'entrenadores', 3, 241, 50),
('crossfit', 'membresias', 3, 593, 42),
('futbol', 'divisiones', 2, 420, 82),
('futbol', 'equipos', 2, 671, 302),
('futbol', 'fichajes', 2, 176, 454),
('futbol', 'jugadores', 2, 164, 426),
('futbol', 'paises', 2, 0, 132),
('miempresa', 'clientes', 1, 118, 461),
('miempresa', 'direcciones', 1, 109, 100),
('miempresa', 'empladosydirecciones', 1, 705, 368),
('miempresa', 'empleados', 1, 365, 36),
('miempresa', 'lineaspedido', 1, 614, 225),
('miempresa', 'pedidos', 1, 119, 280),
('miempresa', 'productos', 1, 882, 57);
...
('crossfit', 'clases', 'Nombre_Clase'),
('crossfit', 'clientes', 'Nombre'),
('futbol', 'equipos', 'nombre'),
('futbol', 'jugadores', 'nombre'),
('miempresa', 'direcciones', 'calle');
...
('root', 'miempresa', 'euromillones', '[]', '2024-09-23 22:42:09');
...
('root', '2024-10-26 15:33:29', '{\"Console\\/Mode\":\"collapse\",\"lang\":\"es\",\"NavigationWidth\":234}');
