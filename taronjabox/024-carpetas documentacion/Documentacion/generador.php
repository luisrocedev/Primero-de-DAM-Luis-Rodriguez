...
function processFolder($source, $target) {
    ...
    foreach ($items as $item) {
        ...
        if (is_dir($sourcePath)) {
            // If it's a folder, create a folder in the target (if it doesn't exist)
            ...
            // Ensure directory exists before creating a file
            ...
            // Ensure the file's directory exists before writing
            $txtDir = dirname($txtFilePath);
...
// Example usage
$sourceFolder = '/Applications/MAMP/htdocs/GitHub/Primero-de-DAM-Luis-Rodriguez/taronjabox'; // Replace with the path to your source folder
