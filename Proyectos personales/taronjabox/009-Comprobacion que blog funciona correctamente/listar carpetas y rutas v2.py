...
listar_estructura('/Applications/MAMP/htdocs/GitHub/Primero-de-DAM-Luis-Rodriguez/taronjabox/009-Comprobacion que blog funciona correctamente', 'estructura_proyecto.txt')
