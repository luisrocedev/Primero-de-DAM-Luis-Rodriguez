...
require_once '../../includes/db.php'; // Subimos dos niveles desde pages/entrenadores
...
<head>
    ...
    <link rel="stylesheet" href="../entrenadores.css"> <!-- Ahora se encuentra en la misma carpeta que el PHP -->
</head>
<body>
    <?php include '../../includes/header.php'; ?> <!-- Subimos dos niveles para incluir el header -->
    ...
    <?php include '../../includes/footer.php'; ?> <!-- Subimos dos niveles para incluir el footer -->
    
    <!-- Ruta al archivo JS -->
    <script src="../entrenadores.js"></script> <!-- Ahora se encuentra en la misma carpeta que el PHP -->
</body>
</html>
