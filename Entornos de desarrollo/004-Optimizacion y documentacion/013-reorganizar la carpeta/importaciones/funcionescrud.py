...
def guardar():
    archivo = open("basededatos/agenda.bin",'wb')                                       # Abro un archivo binario en modo escritura binaria
...
def abrir():
    archivo = open("basededatos/agenda.bin",'rb')                                       # Abro un archivo binario en modo de lectura binaria
