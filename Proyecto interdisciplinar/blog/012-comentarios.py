from flask import Flask                           # Importamos la librería Flask para hacer un micro servidor web
...
def inicio():                                     # Defino la ruta en la que el servidor va a escuchar
    entradas = []                                 # Creo una lista de entradas que de momento está vacía
    peticion = "SELECT * FROM entradas;"          # Preparo una petición de inserción a la base de datos (quiero todas las entradas=
