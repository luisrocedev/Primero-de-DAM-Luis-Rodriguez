...
@aplicacion.route('/login')                                                 # Creo una nueva ruta
def login():                                                                # Defino una funcion  
    usuario = request.args.get('usuario')                                    # Atrapo el parametro get llamado usuario
    contrasena = request.args.get('contrasena')                             # Atrapo el parametro get llamado contrasena
    peticion = f"""  
